...
const plans: Plan[] = [
  ...
  },
  {
    ...
    bestFor: { sw: "Duka au biashara ya huduma inayofuatilia bidhaa, mauzo, madeni, matumizi na nukuu za bei.", en: "A shop or service business tracking products, sales, debts, expenses, and quotations." },
  ...
  },
  {
    ...
    bestFor: { sw: "Biashara inayokua yenye wafanyakazi, miradi/nukuu za bei, ripoti na msaidizi wa AI kwa maamuzi ya kila siku.", en: "A growing business with staff, projects/quotations, reports, and an AI assistant for daily decisions." },

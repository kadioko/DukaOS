...
export default function PrivacyPage() {
  ...
  const sections = lang === "sw"
    ? [
        ...
        ["Kuhifadhi na kufuta", "Tunahifadhi data ya akaunti na biashara wakati akaunti iko hai. Baada ya ombi lililothibitishwa, tunafuta au kuondoa kabisa utambulisho kwenye data ya akaunti na duka ndani ya siku 30. Rekodi ndogo za usalama, audit, malipo, kodi au uthibitisho wa ombi zinaweza kubaki bila utambulisho hadi siku 90, au zaidi inapohitajika kisheria. Backups zinaweza kuchukua hadi siku 90 kusafishwa."],
    ...
    : [
        ...
        ["Third-party services", "We use infrastructure providers to host and store the service. Verification SMS may be sent through NextSMS. If you choose online payment, nTZS receives the payer phone number, amount, and transaction identifiers needed to process and verify the payment. When you choose to contact or send information through WhatsApp, WhatsApp receives the phone number and message sent; order notifications can also be sent through WhatsApp when a shop enables them. We use Sentry for error diagnostics when configured. We do not sell your data or use third-party advertising SDKs."],
        ...
        ["Retention and deletion", "We retain account and business data while the account is active. After a verified request, we delete or irreversibly anonymize account and shop data within 30 days. Limited de-identified security, audit, payment, tax, or request-confirmation records may be kept for up to 90 days, or longer where required by law. Backups can take up to 90 days to age out."],
    ...
    <PublicPageShell>
      <div className="space-y-8">
        <div>
          ...
          <p className="mt-3 text-sm text-gray-500">{lang === "sw" ? "Ilisasishwa Septemba 8, 2026" : "Updated September 8, 2026"}</p>
        </div>
